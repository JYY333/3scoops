                    ...
                    <div class="goods_table_wrap">
	                    ...
	                    <c:if test="${listcheck != 'empty'}">
	                    	<table class="goods_table">
	                    		...
	                    		<tr>
	                    			<td><c:out value="${list.mealkitId}"></c:out></td>
	                    			<td>
	                    				<a class="move" href='<c:out value="${list.mealkitId}"/>'>
	                    					<c:out value="${list.mealkitName}"></c:out>
	                    				</a>
	                    			</td>
	                    			<td><c:out value="${list.authorName}"></c:out></td>
	                    			<td><c:out value="${list.cateName}"></c:out></td>
	                    			<td><c:out value="${list.mealkitStock}"></c:out></td>
...
$(".move").on("click", function(e){
	...
	moveForm.append("<input type='hidden' name='mealkitId' value='"+$(this).attr("href") + "'>");
