					...
					<table class="goods_table">
						...
						<tbody>
							<c:forEach items="${orderList}" var="ol">
								<tr>
									<td>
										<div class="image_wrap" data-mealkitid="${ol.imageList[0].mealkitId}" data-path="${ol.imageList[0].uploadPath}" data-uuid="${ol.imageList[0].uuid}" data-filename="${ol.imageList[0].fileName}">
											<img>
										</div>
									</td>
									<td>${ol.mealkitName}</td>
									<td class="goods_table_price_td">
										<fmt:formatNumber value="${ol.salePrice}" pattern="#,### 원" /> | 수량 ${ol.mealkitCount}개
										<br><fmt:formatNumber value="${ol.totalPrice}" pattern="#,### 원" />
										<br>[<fmt:formatNumber value="${ol.totalPoint}" pattern="#,### 원" />P]
										<input type="hidden" class="individual_mealkitPrice_input" value="${ol.mealkitPrice}">
										<input type="hidden" class="individual_salePrice_input" value="${ol.salePrice}">
										<input type="hidden" class="individual_mealkitCount_input" value="${ol.mealkitCount}">
										<input type="hidden" class="individual_totalPrice_input" value="${ol.salePrice * ol.mealkitCount}">
										...
										<input type="hidden" class="individual_mealkitId_input" value="${ol.mealkitId}">
									</td>
								</tr>							
							</c:forEach>
...
$(".order_btn").on("click", function(){
	...
	$(".goods_table_price_td").each(function(index, element){
		...
		let mealkitId_input = "<input name='orders[" + index + "].mealkitId' type='hidden' value='" + mealkitId + "'>";
		form_contents += mealkitId_input;
		let mealkitCount_input = "<input name='orders[" + index + "].mealkitCount' type='hidden' value='" + mealkitCount + "'>";
