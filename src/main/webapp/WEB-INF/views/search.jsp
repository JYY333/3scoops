					...
					<table class="type_list">
						...
						<tbody id="searchList>">
							<c:forEach items="${list}" var="list">
								<tr>
									<td class="image">
										<div class="image_wrap" data-mealkitid="${list.imageList[0].mealkitId}" data-path="${list.imageList[0].uploadPath}" data-uuid="${list.imageList[0].uuid}" data-filename="${list.imageList[0].fileName}">
											<img>
										</div>										
									</td>
									<td class="detail">
										...
										<div class="title">
											<a href="/goodsDetail/${list.mealkitId}">
												${list.mealkitName}
											</a>
										</div>
										<div class="author">
											<fmt:parseDate var="publeYear" value="${list.publeYear}" pattern="yyyy-MM-dd" />
											${list.authorName} 제조사 | ${list.publisher} | <fmt:formatDate value="${publeYear}" pattern="yyyy-MM-dd"/>
										</div>
									</td>
									<td class="info">
										<div class="rating">
									...
									<td class="price">
										<div class="org_price">
											<del>
												<fmt:formatNumber value="${list.mealkitPrice}" pattern="#,### 원" />
											</del>
										</div>
										<div class="sell_price">
											<strong>
												<fmt:formatNumber value="${list.mealkitPrice * (1-list.mealkitDiscount)}" pattern="#,### 원" />
											</strong>
										</div>
									</td>
									<td class="option"></td>
